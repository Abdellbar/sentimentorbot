...
heroku create visionbotai7 #create a new app 
git init
heroku git:remote -a visionbotai7
git add .
...
heroku config:set WEBEX_TEAMS_ACCESS_TOKEN='Mzg2ODVhMDktZTE0YS00MTM5LWFjODAtOGRhMWQ0OGYxMDczNWJhY2YzNjUtMGU2_PF84_1eb65fdf-9643-417f-9974-ad72cae0e10f'
