...
heroku create visionbotai5 #create a new app 
git init
heroku git:remote -a visionbotai5
git add .
...
heroku config:set WEBEX_TEAMS_ACCESS_TOKEN='YzAwOWUzYjktZmMxYy00YjFiLWI3ZGMtYzFlNzVlYzRiNDJiY2E1OTUzMWEtNzBj_PF84_1eb65fdf-9643-417f-9974-ad72cae0e10f'
