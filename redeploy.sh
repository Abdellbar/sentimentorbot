...
heroku create visionbotai10 #create a new app 
git init
heroku git:remote -a visionbotai10
git add .
...
heroku config:set WEBEX_TEAMS_ACCESS_TOKEN='OGZmNDEzNTQtZDI2YS00Y2RmLWJmZjgtYTFmNWNjMjAzNzIzYTIxYjUxYjUtMWI5_PF84_1eb65fdf-9643-417f-9974-ad72cae0e10f'
